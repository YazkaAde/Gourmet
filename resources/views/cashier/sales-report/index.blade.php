    ...
    <script>
        function applyFilter() {
            ...
            if (startDate && endDate) {
                window.location.href = `{{ route('cashier.sales-report.filter') }}?start_date=${startDate}&end_date=${endDate}`;
            } else {
        ...
        function changePeriod() {
            ...
            window.location.href = `{{ route('cashier.sales-report.index') }}?type=${exportType}`;
        }
    
        function exportReport() {
            const exportType = document.getElementById('exportType').value;
            window.location.href = `{{ route('cashier.sales-report.export') }}?type=${exportType}`;
        }
